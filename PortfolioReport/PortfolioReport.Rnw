...
\begin{figure}
\vspace{0pt}
<<statstable,echo=FALSE,warning=FALSE,eval=TRUE,results='asis'>>=
ABSRTN <- colSums(ptf.daily)*100
# ABSRTN.10 <- colSums(ptf.daily["2010::"])*100
ABSRTN.11 <- colSums(ptf.daily["2020::"])*100
ABSRTN.12 <- colSums(ptf.daily["2021::"])*100
ABSRTN.13 <- colSums(ptf.daily["2022::"])*100
ABSRTN.14 <- colSums(ptf.daily["2023::"])*100
ABSRTN.15 <- colSums(ptf.daily["2024::"])*100
ABSRTN.16 <- colSums(ptf.daily["2025::"])*100
...
statstable <- data.frame(rbind(ABSRTN,CAR,MAXDRAW,RECOV,VOL,SHARPE,SORTINO,SKEWNESS,KURTOSIS,OMEGA,KELLY,ABSRTN.11,ABSRTN.12,ABSRTN.13,ABSRTN.14,ABSRTN.15,ABSRTN.16))
row.names(statstable) <- c("Total Return (% AUM)",
                           ...
                           "Omega Ratio",
                           "Kelly Fraction",
                           "Total Return since 1 Jan 2020 (% AUM)",
                           "Total Return since 1 Jan 2021 (% AUM)",
                           "Total Return since 1 Jan 2022 (% AUM)",
                           "Total Return since 1 Jan 2023 (% AUM)",
                           "Total Return since 1 Jan 2024 (% AUM)",
                           "Total Return since 1 Jan 2025 (% AUM)")
