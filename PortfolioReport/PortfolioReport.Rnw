...
ABSRTN.16 <- colSums(ptf.daily["2016::"])*100
...
statstable <- data.frame(rbind(ABSRTN,CAR,MAXDRAW,RECOV,VOL,COR,SHARPE,SORTINO,SKEWNESS,KURTOSIS,OMEGA,KELLY,ABSRTN.11,ABSRTN.12,ABSRTN.13,ABSRTN.14,ABSRTN.15,ABSRTN.16))
