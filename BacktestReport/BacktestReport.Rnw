...
ABSRTN.11 <- colSums(pnl.daily2["2020::"])*100
ABSRTN.12 <- colSums(pnl.daily2["2021::"])*100
ABSRTN.13 <- colSums(pnl.daily2["2022::"])*100
ABSRTN.14 <- colSums(pnl.daily2["2023::"])*100
ABSRTN.15 <- colSums(pnl.daily2["2024::"])*100 
ABSRTN.16 <- colSums(pnl.daily2["2015::"])*100 
